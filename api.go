...
// LittleEndian byte order (i.e. least significant byte first) for {|u}int{16|32|64} types
var LittleEndian = binary.LittleEndian

// BigEndian byte order (i.e. most significant byte first) for {|u}int{16|32|64} types
